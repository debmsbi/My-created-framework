...
public class imfHomePageTest_with_json_testdata extends BaseTest {
	...
	public void imfpagetitletest_json(String getTitle, String gettext_about, String I_Country_one, String I_Country_two,
			String I_Country_three, String I_Country_four) throws Exception {
